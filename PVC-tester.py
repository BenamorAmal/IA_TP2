...
import BalandBolinhasMarigliano

modules = (  # "MAA09",
			 "BalandBolinhasMarigliano",  # Éventuellement d'autres modules pour comparer plusieurs versions...
)
...
if __name__ == '__main__':
	...
	BalandBolinhasMarigliano.printConstants()
